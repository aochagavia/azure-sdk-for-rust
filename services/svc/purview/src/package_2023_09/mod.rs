...
azure_core::static_url!(DEFAULT_ENDPOINT, "https://purview.azure.com/scan");
impl ClientBuilder {
...
pub mod key_vault_connections {
    ...
    impl Client {
        #[doc = "Gets an Azure Key Vault connection."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `azure_key_vault_name`: The Azure Key Vault name."]
        ...
        #[doc = "Creates or replaces a connection to Azure Key Vault."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `azure_key_vault_name`: The Azure Key Vault name."]
        #[doc = "* `body`: The Azure Key Vault connection definition."]
        pub fn create_or_replace(
            &self,
            azure_key_vault_name: impl Into<String>,
            body: impl Into<models::AzureKeyVault>,
        ...
        #[doc = "Deletes an Azure Key Vault connection associated with the account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `azure_key_vault_name`: The Azure Key Vault name."]
        ...
        #[doc = "Lists Azure Key Vaults in an account."]
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/azureKeyVaults/{}", self.client.endpoint(), &self.azure_key_vault_name))?;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AzureKeyVault>>;
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/azureKeyVaults", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod classification_rules {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets a classification rule."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `classification_rule_name`: The classification rule name."]
        ...
        #[doc = "Creates or replaces a classification rule."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `classification_rule_name`: The classification rule name."]
        #[doc = "* `body`: The classification rule definition."]
        pub fn create_or_replace(
            &self,
            classification_rule_name: impl Into<String>,
            body: impl Into<models::ClassificationRuleUnion>,
        ) -> create_or_replace::RequestBuilder {
            create_or_replace::RequestBuilder {
                client: self.0.clone(),
                classification_rule_name: classification_rule_name.into(),
        ...
        #[doc = "Lists classification rules in Account."]
        pub fn list(&self) -> list::RequestBuilder {
            list::RequestBuilder { client: self.0.clone() }
        }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `classification_rule_name`: The classification rule name."]
        pub fn list_versions_by_rule_name(
            &self,
            classification_rule_name: impl Into<String>,
        ) -> list_versions_by_rule_name::RequestBuilder {
            list_versions_by_rule_name::RequestBuilder {
                client: self.0.clone(),
                classification_rule_name: classification_rule_name.into(),
            }
        ...
        #[doc = "Arguments:"]
        #[doc = "* `classification_rule_name`: The classification rule name."]
        #[doc = "* `classification_rule_version`: The version of the classification rule."]
        #[doc = "* `action`: The action of classification rule."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ClassificationRuleUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ClassificationRuleUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ClassificationRuleUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ClassificationRuleUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_replace {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) classification_rule_name: String,
            pub(crate) body: models::ClassificationRuleUnion,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/classificationrules", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod list_versions_by_rule_name {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
...
pub mod credential {
    ...
    impl Client {
        ...
        #[doc = "Creates or replaces an instance of a credential."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `credential_name`: The credential name."]
        #[doc = "* `body`: The credential definition."]
        pub fn create_or_replace(
            &self,
            credential_name: impl Into<String>,
            body: impl Into<models::CredentialUnion>,
        ) -> create_or_replace::RequestBuilder {
            create_or_replace::RequestBuilder {
                client: self.0.clone(),
                credential_name: credential_name.into(),
        ...
        #[doc = "Deletes a credential associated with the account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `credential_name`: The credential name."]
        ...
        #[doc = "Lists credentials in account."]
        pub fn list(&self) -> list::RequestBuilder {
            list::RequestBuilder { client: self.0.clone() }
        }
    }
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CredentialUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CredentialUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/credentials/{}", self.client.endpoint(), &self.credential_name))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CredentialUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CredentialUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_replace {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) credential_name: String,
            pub(crate) body: models::CredentialUnion,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/credentials", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod data_sources {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets a data source."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        ...
        #[doc = "Creates or replaces a data source."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        #[doc = "* `body`: The data source definition."]
        pub fn create_or_replace(
            &self,
            data_source_name: impl Into<String>,
            body: impl Into<models::DataSourceUnion>,
        ) -> create_or_replace::RequestBuilder {
            create_or_replace::RequestBuilder {
                client: self.0.clone(),
                data_source_name: data_source_name.into(),
        ...
        #[doc = "Lists data sources in Data catalog."]
        pub fn list(&self) -> list::RequestBuilder {
            list::RequestBuilder { client: self.0.clone() }
        }
    }
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DataSourceUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DataSourceUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataSourceUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataSourceUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_replace {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) data_source_name: String,
            pub(crate) body: models::DataSourceUnion,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod filters {
    ...
    impl Client {
        ...
        #[doc = "Creates or replaces a filter."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        #[doc = "* `scan_name`: The scan name."]
        #[doc = "* `body`: The filter definition."]
        pub fn create_or_replace(
            &self,
            data_source_name: impl Into<String>,
            scan_name: impl Into<String>,
            body: impl Into<models::Filter>,
        ) -> create_or_replace::RequestBuilder {
            create_or_replace::RequestBuilder {
                client: self.0.clone(),
                data_source_name: data_source_name.into(),
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Filter>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod integration_runtimes {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists integration runtimes in an account."]
        ...
        #[doc = "Creates or replaces an instance of integration runtime."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `integration_runtime_name`: The integration runtime name."]
        #[doc = "* `body`: The integration runtime definition."]
        pub fn create_or_replace(
            &self,
            integration_runtime_name: impl Into<String>,
            body: impl Into<models::IntegrationRuntimeUnion>,
        ) -> create_or_replace::RequestBuilder {
            create_or_replace::RequestBuilder {
                client: self.0.clone(),
                integration_runtime_name: integration_runtime_name.into(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `integration_runtime_name`: The integration runtime name."]
        #[doc = "* `body`: The request of regenerating authentication key of an integration runtime."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `integration_runtime_name`: The integration runtime name."]
        #[doc = "* `body`: The request of enabling interactive query for integration runtime."]
    ...
    pub mod list_by_account {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/integrationruntimes", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::IntegrationRuntimeUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::IntegrationRuntimeUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::IntegrationRuntimeUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::IntegrationRuntimeUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_replace {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) integration_runtime_name: String,
            pub(crate) body: models::IntegrationRuntimeUnion,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod status {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::IntegrationRuntimeStatusUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::IntegrationRuntimeStatusUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::IntegrationRuntimeStatusUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::IntegrationRuntimeStatusUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod managed_virtual_networks {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists managed virtual networks in an account."]
        pub fn list_by_account(&self) -> list_by_account::RequestBuilder {
            list_by_account::RequestBuilder { client: self.0.clone() }
        }
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `managed_virtual_network_name`: The managed virtual network name. It is restricted to the value 'defaultv2' for now."]
        ...
        #[doc = "Creates or replaces a managed virtual network."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `managed_virtual_network_name`: The managed virtual network name. It is restricted to the value 'defaultv2' for now."]
        #[doc = "* `body`: The managed virtual network resource definition."]
        pub fn create_or_replace(
            &self,
    ...
    pub mod list_by_account {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/managedvirtualnetworks", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagedVirtualNetwork>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagedVirtualNetwork>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod managed_private_endpoints {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists managed private endpoints under a managed virtual network."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `managed_virtual_network_name`: The managed virtual network name. It is restricted to the value 'defaultv2' for now."]
        pub fn list_by_account(&self, managed_virtual_network_name: impl Into<String>) -> list_by_account::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `managed_virtual_network_name`: The managed virtual network name. It is restricted to the value 'defaultv2' for now."]
        #[doc = "* `managed_private_endpoint_name`: The managed private endpoint name."]
        pub fn get(
            &self,
            managed_virtual_network_name: impl Into<String>,
        ...
        #[doc = "Creates or replaces a managed private endpoint."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `managed_virtual_network_name`: The managed virtual network name. It is restricted to the value 'defaultv2' for now."]
        #[doc = "* `managed_private_endpoint_name`: The managed private endpoint name."]
        #[doc = "* `body`: The managed private endpoint resource definition."]
        pub fn create_or_replace(
            &self,
            managed_virtual_network_name: impl Into<String>,
            managed_private_endpoint_name: impl Into<String>,
...
pub mod scans {
    ...
    impl Client {
        ...
        #[doc = "Creates or replaces an instance of a scan."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        #[doc = "* `scan_name`: The scan name."]
        #[doc = "* `body`: The scan definition."]
        pub fn create_or_replace(
            &self,
            data_source_name: impl Into<String>,
            scan_name: impl Into<String>,
            body: impl Into<models::ScanUnion>,
        ) -> create_or_replace::RequestBuilder {
            create_or_replace::RequestBuilder {
                client: self.0.clone(),
                data_source_name: data_source_name.into(),
        ...
        #[doc = "Lists scans in data source."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ScanUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ScanUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ScanUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ScanUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_replace {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) data_source_name: String,
            pub(crate) scan_name: String,
            pub(crate) body: models::ScanUnion,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list_by_data_source {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/datasources/{}/scans", self.client.endpoint(), &self.data_source_name))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod scan_result {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the status of the scan run with ingestion details."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        #[doc = "* `scan_name`: The scan name."]
        #[doc = "* `run_id`: The scan run id."]
        pub fn get_scan_status(
            &self,
            data_source_name: impl Into<String>,
            scan_name: impl Into<String>,
            run_id: impl Into<String>,
        ) -> get_scan_status::RequestBuilder {
            get_scan_status::RequestBuilder {
                client: self.0.clone(),
                data_source_name: data_source_name.into(),
                scan_name: scan_name.into(),
    ...
    pub mod get_scan_status {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ScanResultWithIngestion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ScanResultWithIngestion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ScanResultWithIngestion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ScanResultWithIngestion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_scan_history {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ScanHistoryListWithIngestion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ScanHistoryListWithIngestion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ScanHistoryListWithIngestion, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod scan_rulesets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets a scan ruleset."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scan_ruleset_name`: The scan ruleset name."]
        ...
        #[doc = "Creates or replaces a scan ruleset."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `scan_ruleset_name`: The scan ruleset name."]
        #[doc = "* `body`: The scan rule set definition."]
        pub fn create_or_replace(
            &self,
            scan_ruleset_name: impl Into<String>,
            body: impl Into<models::ScanRulesetUnion>,
        ) -> create_or_replace::RequestBuilder {
            create_or_replace::RequestBuilder {
                client: self.0.clone(),
                scan_ruleset_name: scan_ruleset_name.into(),
        ...
        #[doc = "Lists scan rulesets in data catalog."]
        pub fn list(&self) -> list::RequestBuilder {
            list::RequestBuilder { client: self.0.clone() }
        }
    }
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ScanRulesetUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ScanRulesetUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/scanrulesets/{}", self.client.endpoint(), &self.scan_ruleset_name))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ScanRulesetUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ScanRulesetUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_replace {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) scan_ruleset_name: String,
            pub(crate) body: models::ScanRulesetUnion,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/scanrulesets", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod system_scan_rulesets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all system scan rulesets for an account."]
        pub fn list(&self) -> list::RequestBuilder {
            list::RequestBuilder { client: self.0.clone() }
        }
        #[doc = "Gets a system scan ruleset for a data source."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_type`: The data source type."]
        ...
        #[doc = "Gets a scan ruleset by version."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `version`: The version number."]
        ...
        #[doc = "Gets the latest version of a system scan ruleset."]
        ...
        #[doc = "Lists system scan ruleset versions in data catalog."]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/systemScanRulesets", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SystemScanRulesetUnion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SystemScanRulesetUnion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SystemScanRulesetUnion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SystemScanRulesetUnion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_by_version {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/systemScanRulesets/versions/{}", self.client.endpoint(), &self.version))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod get_latest {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/systemScanRulesets/versions/latest", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod list_versions_by_data_source {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/systemScanRulesets/versions", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod triggers {
    ...
    impl Client {
        ...
        #[doc = "Creates or replaces an instance of a trigger."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        #[doc = "* `scan_name`: The scan name."]
        #[doc = "* `body`: The trigger definition."]
        pub fn create_or_replace(
            &self,
            data_source_name: impl Into<String>,
            scan_name: impl Into<String>,
        ...
        #[doc = "Enables a trigger."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        #[doc = "* `scan_name`: The scan name."]
        pub fn enable(&self, data_source_name: impl Into<String>, scan_name: impl Into<String>) -> enable::RequestBuilder {
        ...
        #[doc = "Disables a trigger."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `data_source_name`: The dataSource name."]
        #[doc = "* `scan_name`: The scan name."]
        pub fn disable(&self, data_source_name: impl Into<String>, scan_name: impl Into<String>) -> disable::RequestBuilder {
    ...
    pub mod enable {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/datasources/{}/scans/{}/triggers/default:enable",
                    self.client.endpoint(),
                    &self.data_source_name,
                    &self.scan_name
                ))?;
    ...
    pub mod disable {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/datasources/{}/scans/{}/triggers/default:disable",
                    self.client.endpoint(),
                    &self.data_source_name,
                    &self.scan_name
                ))?;
