...
pub mod continuous_data_exports {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `export_id`: Unique ID for the continuous data export."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `export_id`: Unique ID for the continuous data export."]
        #[doc = "* `body`: Data export body."]
        pub fn create(&self, export_id: impl Into<String>, body: impl Into<models::ContinuousDataExport>) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                export_id: export_id.into(),
                body: body.into(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `export_id`: Unique ID for the continuous data export."]
        #[doc = "* `body`: Data export patch body."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ContinuousDataExportCollection> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ContinuousDataExportCollection = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ContinuousDataExportCollection, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ContinuousDataExport> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ContinuousDataExport = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ContinuousDataExport>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ContinuousDataExport>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod device_templates {
    ...
    impl Client {
        ...
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `device_template_id`: Unique ID of the device template."]
        ...
        #[doc = "Arguments:"]
        #[doc = "* `device_template_id`: Unique ID of the device template."]
        pub fn list_devices(&self, device_template_id: impl Into<String>) -> list_devices::RequestBuilder {
        ...
        #[doc = "Arguments:"]
        #[doc = "* `device_template_id`: Unique ID of the device template."]
        pub fn get_merged(&self, device_template_id: impl Into<String>) -> get_merged::RequestBuilder {
            get_merged::RequestBuilder {
                client: self.0.clone(),
                device_template_id: device_template_id.into(),
            }
        }
...
pub mod devices {
    ...
    impl Client {
        ...
        #[doc = "Get all cloud property values of a device by device ID."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `device_id`: Unique ID of the device."]
        pub fn get_cloud_properties(&self, device_id: impl Into<String>) -> get_cloud_properties::RequestBuilder {
            get_cloud_properties::RequestBuilder {
                client: self.0.clone(),
                device_id: device_id.into(),
            }
        }
        #[doc = "Replace device cloud properties"]
        #[doc = "Update all cloud property values of a device by device ID."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `device_id`: Unique ID of the device."]
        ...
        ) -> replace_cloud_properties::RequestBuilder {
            replace_cloud_properties::RequestBuilder {
                client: self.0.clone(),
                device_id: device_id.into(),
                body: body.into(),
        ...
        #[doc = "Update cloud property values of a device by device ID."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `device_id`: Unique ID of the device."]
        ...
        pub fn update_cloud_properties(
            ...
            device_id: impl Into<String>,
            body: impl Into<serde_json::Value>,
        ) -> update_cloud_properties::RequestBuilder {
            update_cloud_properties::RequestBuilder {
                client: self.0.clone(),
                device_id: device_id.into(),
                body: body.into(),
    ...
    pub mod get_cloud_properties {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DeviceCloudProperties> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DeviceCloudProperties = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DeviceCloudProperties>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeviceCloudProperties>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
