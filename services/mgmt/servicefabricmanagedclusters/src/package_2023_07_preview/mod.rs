...
impl Client {
    ...
    pub fn managed_apply_maintenance_window_client(&self) -> managed_apply_maintenance_window::Client {
        managed_apply_maintenance_window::Client(self.clone())
    }
    ...
    pub fn managed_maintenance_window_status_client(&self) -> managed_maintenance_window_status::Client {
        managed_maintenance_window_status::Client(self.clone())
    }
...
pub mod application_type_versions {
    ...
    pub mod create_or_update {
        ...
        impl<'a> Headers<'a> {
            #[doc = "The URL to get the status of an ongoing long-running operation."]
            ...
            #[doc = "The URL to get the status of a completed long-running operation."]
...
pub mod managed_maintenance_window_status {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ManagedMaintenanceWindowStatus> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ManagedMaintenanceWindowStatus = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ServiceFabric/managedClusters/{}/getMaintenanceWindowStatus",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.cluster_name
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ManagedMaintenanceWindowStatus>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ManagedMaintenanceWindowStatus>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod managed_apply_maintenance_window {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    pub mod post {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ServiceFabric/managedClusters/{}/applyMaintenanceWindow",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.cluster_name
