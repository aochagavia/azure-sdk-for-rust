...
pub mod server_parameters {
    ...
    impl Client {
        ...
        ) -> list_update_configurations::RequestBuilder {
            list_update_configurations::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
...
pub mod recoverable_servers {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RecoverableServerResource> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RecoverableServerResource = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RecoverableServerResource>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RecoverableServerResource>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod server_based_performance_tier {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PerformanceTierListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PerformanceTierListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.DBforMariaDB/operations", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2018-06-01");
...
pub mod query_texts {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Retrieve the Query-Store query texts for the queryId."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `query_id`: The Query-Store query identifier."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Retrieve the Query-Store query texts for specified queryIds."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `query_ids`: The query identifiers"]
        pub fn list_by_server(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::QueryText> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::QueryText = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::QueryText>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::QueryText>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_server {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::QueryTextsResultList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::QueryTextsResultList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::QueryTextsResultList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                for value in &this.query_ids {
                                    req.url_mut().query_pairs_mut().append_pair("queryIds", &value.to_string());
                                }
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
...
pub mod top_query_statistics {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Retrieve the query statistic for specified identifier."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `query_statistic_id`: The Query Statistic identifier."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Retrieve the Query-Store top queries for specified metric and aggregation."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `parameters`: The required parameters for retrieving top query statistics."]
        pub fn list_by_server(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::QueryStatistic> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::QueryStatistic = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::QueryStatistic>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::QueryStatistic>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_server {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TopQueryStatisticsResultList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TopQueryStatisticsResultList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::TopQueryStatisticsResultList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod wait_statistics {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Retrieve wait statistics for specified identifier."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `wait_statistics_id`: The Wait Statistic identifier."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Retrieve wait statistics for specified aggregation window."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `parameters`: The required parameters for retrieving wait statistics."]
        pub fn list_by_server(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::WaitStatistic> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::WaitStatistic = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::WaitStatistic>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::WaitStatistic>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_server {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::WaitStatisticsResultList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::WaitStatisticsResultList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::WaitStatisticsResultList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
impl Client {
    ...
    pub fn reset_query_performance_insight_data(
        ...
        resource_group_name: impl Into<String>,
        server_name: impl Into<String>,
    ) -> reset_query_performance_insight_data::RequestBuilder {
        reset_query_performance_insight_data::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            resource_group_name: resource_group_name.into(),
    ...
    #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    #[doc = "* `server_name`: The name of the server."]
    #[doc = "* `advisor_name`: The advisor name for recommendation action."]
    #[doc = "* `database_name`: The name of the database."]
    pub fn create_recommended_action_session(
        ...
        database_name: impl Into<String>,
    ) -> create_recommended_action_session::RequestBuilder {
        create_recommended_action_session::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            resource_group_name: resource_group_name.into(),
...
pub mod reset_query_performance_insight_data {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::QueryPerformanceInsightResetDataResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::QueryPerformanceInsightResetDataResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::QueryPerformanceInsightResetDataResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::QueryPerformanceInsightResetDataResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod create_recommended_action_session {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforMariaDB/servers/{}/advisors/{}/createRecommendedActionSession" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . server_name , & self . advisor_name)) ? ;
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "2018-06-01");
...
pub mod advisors {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get a recommendation action advisor."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "List recommendation action advisors."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_server {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AdvisorsResultList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AdvisorsResultList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AdvisorsResultList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod recommended_actions {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Retrieve recommended actions from the advisor."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `advisor_name`: The advisor name for recommendation action."]
        #[doc = "* `recommended_action_name`: The recommended action name."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RecommendationAction> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RecommendationAction = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.DBforMariaDB/servers/{}/advisors/{}/recommendedActions/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.server_name,
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RecommendationAction>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RecommendationAction>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_server {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RecommendationActionsResultList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RecommendationActionsResultList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn into_stream(self) -> azure_core::Pageable<models::RecommendationActionsResultList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod location_based_recommended_action_sessions_operation_status {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::RecommendedActionSessionsOperationStatus> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::RecommendedActionSessionsOperationStatus = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.DBforMariaDB/locations/{}/recommendedActionSessionsAzureAsyncOperation/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.location_name,
                    &self.operation_id
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::RecommendedActionSessionsOperationStatus>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::RecommendedActionSessionsOperationStatus>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod location_based_recommended_action_sessions_result {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Recommendation action session operation result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `location_name`: The name of the location."]
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::RecommendationActionsResultList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    ...
                    async move {
                        ...
                        let rsp = match rsp.status() {
                            azure_core::StatusCode::OK => Ok(Response(rsp)),
                            azure_core::StatusCode::Created => Ok(Response(rsp)),
                            status_code => Err(azure_core::error::Error::from(azure_core::error::ErrorKind::HttpResponse {
                                status: status_code,
                                error_code: None,
                            })),
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.DBforMariaDB/locations/{}/recommendedActionSessionsOperationResults/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.location_name,
                    &self.operation_id
...
pub mod private_endpoint_connections {
    ...
    impl Client {
        ...
        #[doc = "Updates private endpoint connection with the specified tags."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        #[doc = "* `parameters`: Parameters supplied to the Update private endpoint connection Tags operation."]
        pub fn update_tags(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod private_link_resources {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the private link resources for MariaDB server."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
        ...
        #[doc = "Gets a private link resource for MariaDB server."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `server_name`: The name of the server."]
