    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.AVS/operations", self.client.endpoint(),))?;
...
pub mod datastores {
    ...
    impl Client {
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `cluster_name`: Name of the cluster in the private cloud"]
        #[doc = "* `datastore_name`: Name of the datastore in the private cloud cluster"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `cluster_name`: Name of the cluster in the private cloud"]
        #[doc = "* `datastore_name`: Name of the datastore in the private cloud cluster"]
        #[doc = "* `datastore`: A datastore in a private cloud cluster"]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod global_reach_connections {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `global_reach_connection_name`: Name of the global reach connection in the private cloud"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: The name of the private cloud."]
        #[doc = "* `global_reach_connection_name`: Name of the global reach connection in the private cloud"]
        #[doc = "* `global_reach_connection`: A global reach connection in the private cloud"]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod workload_networks {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `workload_network_name`: Name for the workload network in the private cloud"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            private_cloud_name: impl Into<String>,
            workload_network_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                private_cloud_name: private_cloud_name.into(),
                workload_network_name: workload_network_name.into(),
            }
        }
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `segment_id`: NSX Segment identifier. Generally the same as the Segment's display name"]
        pub fn get_segment(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `segment_id`: NSX Segment identifier. Generally the same as the Segment's display name"]
        #[doc = "* `workload_network_segment`: NSX Segment"]
        ...
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `dhcp_id`: NSX DHCP identifier. Generally the same as the DHCP display name"]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        pub fn get_dhcp(
            &self,
            subscription_id: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `dhcp_id`: NSX DHCP identifier. Generally the same as the DHCP display name"]
        #[doc = "* `workload_network_dhcp`: NSX DHCP"]
        pub fn create_dhcp(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `gateway_id`: NSX Gateway identifier. Generally the same as the Gateway's display name"]
        pub fn get_gateway(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `port_mirroring_id`: NSX Port Mirroring identifier. Generally the same as the Port Mirroring display name"]
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `port_mirroring_id`: NSX Port Mirroring identifier. Generally the same as the Port Mirroring display name"]
        #[doc = "* `workload_network_port_mirroring`: NSX port mirroring"]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `vm_group_id`: NSX VM Group identifier. Generally the same as the VM Group's display name"]
        pub fn get_vm_group(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `vm_group_id`: NSX VM Group identifier. Generally the same as the VM Group's display name"]
        #[doc = "* `workload_network_vm_group`: NSX VM Group"]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `virtual_machine_id`: Virtual Machine identifier"]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `dns_service_id`: NSX DNS Service identifier. Generally the same as the DNS Service's display name"]
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `dns_service_id`: NSX DNS Service identifier. Generally the same as the DNS Service's display name"]
        #[doc = "* `workload_network_dns_service`: NSX DNS Service"]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `dns_zone_id`: NSX DNS Zone identifier. Generally the same as the DNS Zone's display name"]
        pub fn get_dns_zone(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `dns_zone_id`: NSX DNS Zone identifier. Generally the same as the DNS Zone's display name"]
        #[doc = "* `workload_network_dns_zone`: NSX DNS Zone"]
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `public_ip_id`: NSX Public IP Block identifier. Generally the same as the Public IP Block's display name"]
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `public_ip_id`: NSX Public IP Block identifier. Generally the same as the Public IP Block's display name"]
        #[doc = "* `workload_network_public_ip`: NSX Public IP Block"]
    ...
    pub mod get {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) private_cloud_name: String,
            pub(crate) workload_network_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod list_dhcp {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/workloadNetworks/default/dhcpConfigurations" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
    ...
    pub mod get_dhcp {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/workloadNetworks/default/dhcpConfigurations/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name , & self . dhcp_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
    ...
    pub mod list_port_mirroring {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/workloadNetworks/default/portMirroringProfiles" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
    ...
    pub mod get_port_mirroring {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/workloadNetworks/default/portMirroringProfiles/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name , & self . port_mirroring_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
    ...
    pub mod list_virtual_machines {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/workloadNetworks/default/virtualMachines" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
    ...
    pub mod get_virtual_machine {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/workloadNetworks/default/virtualMachines/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name , & self . virtual_machine_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
    ...
    pub mod get_dns_service {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/workloadNetworks/default/dnsServices/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name , & self . dns_service_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
...
pub mod cloud_links {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `cloud_link_name`: Name of the cloud link resource"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: The name of the private cloud."]
        #[doc = "* `cloud_link_name`: Name of the cloud link resource"]
        #[doc = "* `cloud_link`: A cloud link in the private cloud"]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod addons {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `addon_name`: Name of the addon for the private cloud"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: The name of the private cloud."]
        #[doc = "* `addon_name`: Name of the addon for the private cloud"]
        #[doc = "* `addon`: A addon in the private cloud"]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod virtual_machines {
    ...
    impl Client {
        ...
        #[doc = "* `cluster_name`: Name of the cluster in the private cloud"]
        #[doc = "* `virtual_machine_id`: Virtual Machine identifier"]
        #[doc = "* `restrict_movement`: Whether VM DRS-driven movement is restricted (Enabled) or not (Disabled)"]
    ...
    pub mod restrict_movement {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.AVS/privateClouds/{}/clusters/{}/virtualMachines/{}/restrictMovement" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . private_cloud_name , & self . cluster_name , & self . virtual_machine_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-05-01");
...
pub mod placement_policies {
    ...
    impl Client {
        ...
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `cluster_name`: Name of the cluster in the private cloud"]
        #[doc = "* `placement_policy_name`: Name of the VMware vSphere Distributed Resource Scheduler (DRS) placement policy"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `cluster_name`: Name of the cluster in the private cloud"]
        #[doc = "* `placement_policy_name`: Name of the VMware vSphere Distributed Resource Scheduler (DRS) placement policy"]
        #[doc = "* `placement_policy`: A placement policy in the private cloud cluster"]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `cluster_name`: Name of the cluster in the private cloud"]
        #[doc = "* `placement_policy_name`: Name of the VMware vSphere Distributed Resource Scheduler (DRS) placement policy"]
        #[doc = "* `placement_policy_update`: The placement policy properties that may be updated"]
        pub fn update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod script_packages {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `script_package_name`: Name of the script package in the private cloud"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod script_cmdlets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "List script cmdlet resources available for a private cloud to create a script execution resource on a private cloud"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Return information about a script cmdlet resource in a specific package on a private cloud"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `script_package_name`: Name of the script package in the private cloud"]
        #[doc = "* `script_cmdlet_name`: Name of the script cmdlet resource in the script package in the private cloud"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
...
pub mod script_executions {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `private_cloud_name`: Name of the private cloud"]
        #[doc = "* `script_execution_name`: Name of the user-invoked script execution resource"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "* `private_cloud_name`: The name of the private cloud."]
        #[doc = "* `script_execution_name`: Name of the user-invoked script execution resource"]
        #[doc = "* `script_execution`: A script running in the private cloud"]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
