...
impl Client {
    ...
    pub fn api_definitions_client(&self) -> api_definitions::Client {
        api_definitions::Client(self.clone())
    }
    pub fn api_versions_client(&self) -> api_versions::Client {
        api_versions::Client(self.clone())
    }
    pub fn apis_client(&self) -> apis::Client {
        apis::Client(self.clone())
    }
    ...
    pub fn metadata_schemas_client(&self) -> metadata_schemas::Client {
        metadata_schemas::Client(self.clone())
    }
...
pub mod services {
    ...
    impl Client {
        ...
        pub fn export_metadata_schema(
            ...
            resource_group_name: impl Into<String>,
            service_name: impl Into<String>,
            payload: impl Into<models::MetadataSchemaExportRequest>,
        ) -> export_metadata_schema::RequestBuilder {
            export_metadata_schema::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod export_metadata_schema {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MetadataSchemaExportResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MetadataSchemaExportResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) service_name: String,
            pub(crate) payload: models::MetadataSchemaExportRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod metadata_schemas {
    ...
    impl Client {
        ...
        pub fn get(
            ...
            resource_group_name: impl Into<String>,
            service_name: impl Into<String>,
            metadata_schema_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        pub fn create_or_update(
            ...
            service_name: impl Into<String>,
            metadata_schema_name: impl Into<String>,
            payload: impl Into<models::MetadataSchema>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MetadataSchema> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MetadataSchema = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) service_name: String,
            pub(crate) metadata_schema_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MetadataSchema>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MetadataSchema>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) service_name: String,
            pub(crate) metadata_schema_name: String,
            pub(crate) payload: models::MetadataSchema,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod workspaces {
    ...
    impl Client {
        ...
        pub fn create_or_update(
            ...
            service_name: impl Into<String>,
            workspace_name: impl Into<String>,
            payload: impl Into<models::Workspace>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) service_name: String,
            pub(crate) workspace_name: String,
            pub(crate) payload: models::Workspace,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod apis {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Api> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Api = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Api>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Api>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod api_versions {
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ApiVersion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ApiVersion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ApiVersion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ApiVersion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) api_name: String,
            pub(crate) version_name: String,
            pub(crate) payload: models::ApiVersion,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod api_definitions {
    ...
    impl Client {
        ...
        pub fn create_or_update(
            ...
            version_name: impl Into<String>,
            definition_name: impl Into<String>,
            payload: impl Into<models::ApiDefinition>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        pub fn export_specification(
            ...
            version_name: impl Into<String>,
            definition_name: impl Into<String>,
        ) -> export_specification::RequestBuilder {
            export_specification::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ApiDefinition> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ApiDefinition = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ApiDefinition>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ApiDefinition>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) version_name: String,
            pub(crate) definition_name: String,
            pub(crate) payload: models::ApiDefinition,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
    ...
    pub mod import_specification {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) version_name: String,
            pub(crate) definition_name: String,
            pub(crate) payload: models::ApiSpecImportRequest,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
...
pub mod environments {
    ...
    impl Client {
        ...
        pub fn create_or_update(
            ...
            workspace_name: impl Into<String>,
            environment_name: impl Into<String>,
            payload: impl Into<models::Environment>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) workspace_name: String,
            pub(crate) environment_name: String,
            pub(crate) payload: models::Environment,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
