...
pub mod billing_subscriptions {
    ...
    impl Client {
        ...
        pub fn get(&self, billing_account_name: impl Into<String>, subscription_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                billing_account_name: billing_account_name.into(),
...
pub mod invoices {
    ...
    impl Client {
        ...
        pub fn get(&self, billing_account_name: impl Into<String>, invoice_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                billing_account_name: billing_account_name.into(),
        ...
        #[doc = "Arguments:"]
        #[doc = "* `invoice_name`: The ID that uniquely identifies an invoice."]
        pub fn get_by_id(&self, invoice_name: impl Into<String>) -> get_by_id::RequestBuilder {
        ...
        ) -> download_invoice::RequestBuilder {
            download_invoice::RequestBuilder {
                client: self.0.clone(),
                billing_account_name: billing_account_name.into(),
                invoice_name: invoice_name.into(),
        ...
        pub fn get_by_subscription_and_invoice_id(
            ...
            subscription_id: impl Into<String>,
            invoice_name: impl Into<String>,
        ) -> get_by_subscription_and_invoice_id::RequestBuilder {
            get_by_subscription_and_invoice_id::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                invoice_name: invoice_name.into(),
        ...
        pub fn download_billing_subscription_invoice(
            ...
            invoice_name: impl Into<String>,
            download_token: impl Into<String>,
        ) -> download_billing_subscription_invoice::RequestBuilder {
            download_billing_subscription_invoice::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                invoice_name: invoice_name.into(),
...
pub mod promotion {
    ...
    impl Client {
        ...
        pub fn get(&self, promotion_id: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn check_eligibility(
            ...
            subscription_id: impl Into<String>,
        ) -> check_eligibility::RequestBuilder {
            check_eligibility::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PromotionResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PromotionResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PromotionResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PromotionResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod check_eligibility {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PromotionCheckEligibilityResponse> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PromotionCheckEligibilityResponse = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PromotionCheckEligibilityResponse>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PromotionCheckEligibilityResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod promotions {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PromotionList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PromotionList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::PromotionList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Billing/promotions", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2020-09-01-preview");
