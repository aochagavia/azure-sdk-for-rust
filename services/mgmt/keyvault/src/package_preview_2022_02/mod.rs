...
pub mod keys {
    ...
    impl Client {
        ...
        #[doc = "* `key_name`: The name of the key to be created. The value you provide may be copied globally for the purpose of running the service. The value provided should not include personally identifiable or sensitive information."]
...
pub mod managed_hsms {
    ...
    impl Client {
        ...
        #[doc = "Checks that the managed hsm name is valid and is not already in use."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `mhsm_name`: The name of the managed hsm."]
        #[doc = "* `subscription_id`: Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call."]
        pub fn check_mhsm_name_availability(
            &self,
            mhsm_name: impl Into<models::CheckMhsmNameAvailabilityParameters>,
            subscription_id: impl Into<String>,
        ) -> check_mhsm_name_availability::RequestBuilder {
            check_mhsm_name_availability::RequestBuilder {
                client: self.0.clone(),
                mhsm_name: mhsm_name.into(),
                subscription_id: subscription_id.into(),
            }
        }
    }
    ...
    pub mod check_mhsm_name_availability {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CheckMhsmNameAvailabilityResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CheckMhsmNameAvailabilityResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) mhsm_name: models::CheckMhsmNameAvailabilityParameters,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.KeyVault/checkMhsmNameAvailability",
                    self.client.endpoint(),
                    &self.subscription_id
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CheckMhsmNameAvailabilityResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CheckMhsmNameAvailabilityResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod secrets {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the Resource Group to which the vault belongs."]
        #[doc = "* `vault_name`: Name of the vault"]
        #[doc = "* `secret_name`: Name of the secret. The value you provide may be copied globally for the purpose of running the service. The value provided should not include personally identifiable or sensitive information."]
