...
impl Client {
    ...
    pub fn analytics_connectors_client(&self) -> analytics_connectors::Client {
        analytics_connectors::Client(self.clone())
    }
...
pub mod workspace_private_endpoint_connections {
    ...
    pub mod list_by_workspace {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.HealthcareApis/workspaces/{}/privateEndpointConnections",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.workspace_name
...
pub mod analytics_connectors {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all Analytics Connectors for the given workspace."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the service instance."]
        #[doc = "* `subscription_id`: The subscription identifier."]
        ...
        #[doc = "Gets the properties of the specified Analytics Connector."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the service instance."]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `workspace_name`: The name of workspace resource."]
        #[doc = "* `analytics_connector_name`: The name of Analytics Connector resource."]
        pub fn get(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            workspace_name: impl Into<String>,
            analytics_connector_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
                workspace_name: workspace_name.into(),
                analytics_connector_name: analytics_connector_name.into(),
            }
        }
        #[doc = "Creates or updates a Analytics Connector resource with the specified parameters."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the service instance."]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `workspace_name`: The name of workspace resource."]
        #[doc = "* `analytics_connector_name`: The name of Analytics Connector resource."]
        #[doc = "* `analytics_connector`: The parameters for creating or updating a Analytics Connector resource."]
        pub fn create_or_update(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            workspace_name: impl Into<String>,
            analytics_connector_name: impl Into<String>,
            analytics_connector: impl Into<models::AnalyticsConnector>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                ...
                workspace_name: workspace_name.into(),
                analytics_connector_name: analytics_connector_name.into(),
                analytics_connector: analytics_connector.into(),
            }
        }
        #[doc = "Patch Analytics Connector Service details."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the service instance."]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `workspace_name`: The name of workspace resource."]
        #[doc = "* `analytics_connector_name`: The name of Analytics Connector resource."]
        #[doc = "* `analytics_connector_patch_resource`: The parameters for updating a Analytics Connector."]
        pub fn update(
            &self,
            resource_group_name: impl Into<String>,
            subscription_id: impl Into<String>,
            workspace_name: impl Into<String>,
            analytics_connector_name: impl Into<String>,
            analytics_connector_patch_resource: impl Into<models::AnalyticsConnectorPatchResource>,
        ) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                ...
                workspace_name: workspace_name.into(),
                analytics_connector_name: analytics_connector_name.into(),
                analytics_connector_patch_resource: analytics_connector_patch_resource.into(),
            }
        }
        #[doc = "Deletes a Analytics Connector."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The subscription identifier."]
        #[doc = "* `resource_group_name`: The name of the resource group that contains the service instance."]
    ...
    pub mod list_by_workspace {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AnalyticsConnectorCollection> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AnalyticsConnectorCollection = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::AnalyticsConnectorCollection, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.HealthcareApis/workspaces/{}/analyticsconnectors",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.workspace_name
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::AnalyticsConnector> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::AnalyticsConnector = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) subscription_id: String,
            pub(crate) workspace_name: String,
            pub(crate) analytics_connector_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AnalyticsConnector>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AnalyticsConnector>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) workspace_name: String,
            pub(crate) analytics_connector_name: String,
            pub(crate) analytics_connector: models::AnalyticsConnector,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.analytics_connector)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) workspace_name: String,
            pub(crate) analytics_connector_name: String,
            pub(crate) analytics_connector_patch_resource: models::AnalyticsConnectorPatchResource,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.analytics_connector_patch_resource)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
