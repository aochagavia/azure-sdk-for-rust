...
impl Client {
    ...
    pub fn sap_landscape_monitor_client(&self) -> sap_landscape_monitor::Client {
        sap_landscape_monitor::Client(self.clone())
    }
...
impl Client {
    #[doc = "Get SAP sizing recommendations by providing input SAPS for application tier and memory required for database tier"]
    #[doc = ""]
    #[doc = "Arguments:"]
    ...
    ) -> sap_sizing_recommendations::RequestBuilder {
        sap_sizing_recommendations::RequestBuilder {
            client: self.clone(),
    ...
    #[doc = "Get a list of SAP supported SKUs for ASCS, Application and Database tier."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `subscription_id`: The ID of the target subscription."]
    #[doc = "* `location`: The name of Azure region."]
    pub fn sap_supported_sku(&self, subscription_id: impl Into<String>, location: impl Into<String>) -> sap_supported_sku::RequestBuilder {
        sap_supported_sku::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            location: location.into(),
    ...
    #[doc = "Get the SAP Disk Configuration Layout prod/non-prod SAP System."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `subscription_id`: The ID of the target subscription."]
    #[doc = "* `location`: The name of Azure region."]
    pub fn sap_disk_configurations(
        ...
        subscription_id: impl Into<String>,
        location: impl Into<String>,
    ) -> sap_disk_configurations::RequestBuilder {
        sap_disk_configurations::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            location: location.into(),
    ...
    #[doc = "Get the recommended SAP Availability Zone Pair Details for your region."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `subscription_id`: The ID of the target subscription."]
    #[doc = "* `location`: The name of Azure region."]
    pub fn sap_availability_zone_details(
        ...
        subscription_id: impl Into<String>,
        location: impl Into<String>,
    ) -> sap_availability_zone_details::RequestBuilder {
        sap_availability_zone_details::RequestBuilder {
            client: self.clone(),
            subscription_id: subscription_id.into(),
            location: location.into(),
...
pub mod sap_sizing_recommendations {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/providers/Microsoft.Workloads/locations/{}/sapVirtualInstanceMetadata/default/getSizingRecommendations" , self . client . endpoint () , & self . subscription_id , & self . location)) ? ;
...
pub mod sap_supported_sku {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::SapSupportedResourceSkusResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::SapSupportedResourceSkusResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = azure_core::Url::parse(&format!(
                "{}/subscriptions/{}/providers/Microsoft.Workloads/locations/{}/sapVirtualInstanceMetadata/default/getSapSupportedSku",
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::SapSupportedResourceSkusResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapSupportedResourceSkusResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod sap_disk_configurations {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::SapDiskConfigurationsResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::SapDiskConfigurationsResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = azure_core::Url::parse(&format!(
                "{}/subscriptions/{}/providers/Microsoft.Workloads/locations/{}/sapVirtualInstanceMetadata/default/getDiskConfigurations",
                self.client.endpoint(),
                &self.subscription_id,
                &self.location
            ))?;
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::SapDiskConfigurationsResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapDiskConfigurationsResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod sap_availability_zone_details {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::SapAvailabilityZoneDetailsResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::SapAvailabilityZoneDetailsResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/providers/Microsoft.Workloads/locations/{}/sapVirtualInstanceMetadata/default/getAvailabilityZoneDetails" , self . client . endpoint () , & self . subscription_id , & self . location)) ? ;
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "2022-11-01-preview");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::SapAvailabilityZoneDetailsResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapAvailabilityZoneDetailsResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod sap_virtual_instances {
    ...
    impl Client {
        #[doc = "Gets a Virtual Instance for SAP solutions resource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `sap_virtual_instance_name`: The name of the Virtual Instances for SAP solutions resource"]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
        ...
        #[doc = "Creates a Virtual Instance for SAP solutions (VIS) resource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Updates a Virtual Instance for SAP solutions resource"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Deletes a Virtual Instance for SAP solutions resource and its child resources, that is the associated Central Services Instance, Application Server Instances and Database Instance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets all Virtual Instances for SAP solutions resources in a Resource Group."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets all Virtual Instances for SAP solutions resources in a Subscription."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        ...
        #[doc = "Starts the SAP application, that is the Central Services instance and Application server instances."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Stops the SAP Application, that is the Application server instances and Central Services instance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapVirtualInstance> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapVirtualInstance = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    ...
                    &self.sap_virtual_instance_name
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SapVirtualInstance>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapVirtualInstance>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        impl RequestBuilder {
            #[doc = "Virtual Instance for SAP solutions resource request body."]
    ...
    pub mod update {
        ...
        impl RequestBuilder {
            #[doc = "Request body to update a Virtual Instance for SAP solutions resource."]
    ...
    pub mod list_by_resource_group {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapVirtualInstanceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapVirtualInstanceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SapVirtualInstanceList, azure_core::error::Error> {
...
pub mod sap_central_instances {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the SAP Central Services Instance resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `sap_virtual_instance_name`: The name of the Virtual Instances for SAP solutions resource"]
        #[doc = "* `central_instance_name`: Central Services Instance resource name string modeled as parameter for auto generation to work correctly."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Creates the SAP Central Services Instance resource. <br><br>This will be used by service only. PUT operation on this resource by end user will return a Bad Request error."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Updates the SAP Central Services Instance resource. <br><br>This can be used to update tags on the resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Deletes the SAP Central Services Instance resource. <br><br>This will be used by service only. Delete operation on this resource by end user will return a Bad Request error. You can delete the parent resource, which is the Virtual Instance for SAP solutions resource, using the delete operation on it."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Lists the SAP Central Services Instance resource for the given Virtual Instance for SAP solutions resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Starts the SAP Central Services Instance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Stops the SAP Central Services Instance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapCentralServerInstance> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapCentralServerInstance = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SapCentralServerInstance>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapCentralServerInstance>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        impl RequestBuilder {
            #[doc = "The SAP Central Services Instance request body."]
    ...
    pub mod update {
        ...
        impl RequestBuilder {
            #[doc = "The SAP Central Services Instance resource request body."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapCentralInstanceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapCentralInstanceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SapCentralInstanceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod start_instance {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/sapVirtualInstances/{}/centralInstances/{}/start",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.sap_virtual_instance_name,
    ...
    pub mod stop_instance {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/sapVirtualInstances/{}/centralInstances/{}/stop",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.sap_virtual_instance_name,
...
pub mod sap_database_instances {
    ...
    impl Client {
        ...
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `sap_virtual_instance_name`: The name of the Virtual Instances for SAP solutions resource"]
        #[doc = "* `database_instance_name`: Database resource name string modeled as parameter for auto generation to work correctly."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapDatabaseInstance> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapDatabaseInstance = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SapDatabaseInstance>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapDatabaseInstance>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        impl RequestBuilder {
            #[doc = "Request body of Database resource of a SAP system."]
    ...
    pub mod update {
        ...
        impl RequestBuilder {
            #[doc = "Database resource update request body."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapDatabaseInstanceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapDatabaseInstanceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SapDatabaseInstanceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod start_instance {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/sapVirtualInstances/{}/databaseInstances/{}/start",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.sap_virtual_instance_name,
    ...
    pub mod stop_instance {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/sapVirtualInstances/{}/databaseInstances/{}/stop",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.sap_virtual_instance_name,
...
pub mod sap_application_server_instances {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets the SAP Application Server Instance corresponding to the Virtual Instance for SAP solutions resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `sap_virtual_instance_name`: The name of the Virtual Instances for SAP solutions resource"]
        #[doc = "* `application_instance_name`: The name of SAP Application Server instance resource."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Puts the SAP Application Server Instance resource. <br><br>This will be used by service only. PUT by end user will return a Bad Request error."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Puts the SAP Application Server Instance resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Deletes the SAP Application Server Instance resource. <br><br>This operation will be used by service only. Delete by end user will return a Bad Request error."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Lists the SAP Application Server Instance resources for a given Virtual Instance for SAP solutions resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Stops the SAP Application Server Instance."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapApplicationServerInstance> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapApplicationServerInstance = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/sapVirtualInstances/{}/applicationInstances/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.sap_virtual_instance_name,
                    &self.application_instance_name
                ))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SapApplicationServerInstance>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapApplicationServerInstance>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        impl RequestBuilder {
            #[doc = "The SAP Application Server Instance resource request body."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapApplicationServerInstanceList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapApplicationServerInstanceList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::SapApplicationServerInstanceList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod start_instance {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/sapVirtualInstances/{}/applicationInstances/{}/start" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . sap_virtual_instance_name , & self . application_instance_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01-preview");
    ...
    pub mod stop_instance {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/sapVirtualInstances/{}/applicationInstances/{}/stop" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . sap_virtual_instance_name , & self . application_instance_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01-preview");
...
pub mod monitors {
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::MonitorListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::MonitorListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::MonitorListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Monitor> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Monitor = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Monitor>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Monitor>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod sap_landscape_monitor {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets configuration values for Single Pane Of Glass for SAP monitor."]
        #[doc = "Gets configuration values for Single Pane Of Glass for SAP monitor for the specified subscription, resource group, and resource name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Creates a SAP Landscape Monitor Dashboard."]
        #[doc = "Creates a SAP Landscape Monitor Dashboard for the specified subscription, resource group, and resource name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `monitor_name`: Name of the SAP monitor resource."]
        #[doc = "* `sap_landscape_monitor_parameter`: Request body representing a configuration for Sap Landscape Monitor Dashboard"]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            monitor_name: impl Into<String>,
            sap_landscape_monitor_parameter: impl Into<models::SapLandscapeMonitor>,
        ) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                monitor_name: monitor_name.into(),
                sap_landscape_monitor_parameter: sap_landscape_monitor_parameter.into(),
            }
        }
        #[doc = "Patches the SAP Landscape Monitor Dashboard."]
        #[doc = "Patches the SAP Landscape Monitor Dashboard for the specified subscription, resource group, and SAP monitor name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Deletes a SAP Landscape Monitor Dashboard."]
        #[doc = "Deletes a SAP Landscape Monitor Dashboard with the specified subscription, resource group, and SAP monitor name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapLandscapeMonitor> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapLandscapeMonitor = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/monitors/{}/sapLandscapeMonitor/default",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.monitor_name
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SapLandscapeMonitor>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapLandscapeMonitor>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) monitor_name: String,
            pub(crate) sap_landscape_monitor_parameter: models::SapLandscapeMonitor,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.sap_landscape_monitor_parameter)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SapLandscapeMonitorListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SapLandscapeMonitorListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Workloads/monitors/{}/sapLandscapeMonitor",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.monitor_name
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SapLandscapeMonitorListResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SapLandscapeMonitorListResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.Workloads/operations", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2022-11-01-preview");
