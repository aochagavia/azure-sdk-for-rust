...
pub mod mobile_networks {
    ...
    pub mod list_sim_ids {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SimIdListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SimIdListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SimIdListResult>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SimIdListResult>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
...
pub mod sims {
    ...
    impl Client {
        ...
        pub fn list_by_sim_group(
            ...
            subscription_id: impl Into<String>,
            sim_group_name: impl Into<String>,
        ) -> list_by_sim_group::RequestBuilder {
            list_by_sim_group::RequestBuilder {
                client: self.0.clone(),
                resource_group_name: resource_group_name.into(),
                subscription_id: subscription_id.into(),
...
pub mod packet_core_control_plane_versions {
    ...
    impl Client {
        ...
        pub fn list_by_resource_group(&self) -> list_by_resource_group::RequestBuilder {
            list_by_resource_group::RequestBuilder { client: self.0.clone() }
        }
    }
    pub mod get {
        use super::models;
