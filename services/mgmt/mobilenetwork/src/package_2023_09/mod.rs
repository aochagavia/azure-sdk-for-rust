...
impl Client {
    ...
    pub fn diagnostics_packages_client(&self) -> diagnostics_packages::Client {
        diagnostics_packages::Client(self.clone())
    }
...
pub mod attached_data_networks {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/packetCoreDataPlanes/{}/attachedDataNetworks/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name , & self . packet_core_data_plane_name , & self . attached_data_network_name)) ? ;
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AttachedDataNetwork>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::AttachedDataNetwork>>;
    ...
    pub mod list_by_packet_core_data_plane {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/packetCoreDataPlanes/{}/attachedDataNetworks" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name , & self . packet_core_data_plane_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod data_networks {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DataNetwork>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DataNetwork>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod diagnostics_packages {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets information about the specified diagnostics package."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `packet_core_control_plane_name`: The name of the packet core control plane."]
        #[doc = "* `diagnostics_package_name`: The name of the diagnostics package."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            packet_core_control_plane_name: impl Into<String>,
            diagnostics_package_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                packet_core_control_plane_name: packet_core_control_plane_name.into(),
                diagnostics_package_name: diagnostics_package_name.into(),
            }
        }
        #[doc = "Creates or updates a diagnostics package."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Deletes the specified diagnostics package."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Lists all the diagnostics packages under a packet core control plane."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DiagnosticsPackage> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DiagnosticsPackage = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) packet_core_control_plane_name: String,
            pub(crate) diagnostics_package_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/diagnosticsPackages/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name , & self . diagnostics_package_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DiagnosticsPackage>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DiagnosticsPackage>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_packet_core_control_plane {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::DiagnosticsPackageListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::DiagnosticsPackageListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::DiagnosticsPackageListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/diagnosticsPackages" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod mobile_networks {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::MobileNetwork>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::MobileNetwork>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod operations {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!("{}/providers/Microsoft.MobileNetwork/operations", self.client.endpoint(),))?;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod packet_captures {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Gets information about the specified packet capture session."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Creates or updates a packet capture."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `packet_core_control_plane_name`: The name of the packet core control plane."]
        #[doc = "* `packet_capture_name`: The name of the packet capture session."]
        #[doc = "* `parameters`: Parameters supplied to the create or update packet capture operation."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Deletes the specified packet capture."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Stop a packet capture session."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Lists all the packet capture sessions under a packet core control plane."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PacketCapture> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PacketCapture = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/packetCaptures/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PacketCapture>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PacketCapture>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod stop {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/packetCaptures/{}/stop" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name , & self . packet_capture_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
    ...
    pub mod list_by_packet_core_control_plane {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::PacketCaptureListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::PacketCaptureListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::PacketCaptureListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = this.url()?;
...
pub mod packet_core_control_planes {
    ...
    impl Client {
        ...
        #[doc = "Patch packet core control plane resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `packet_core_control_plane_name`: The name of the packet core control plane."]
        #[doc = "* `parameters`: Parameters supplied to patch packet core control plane resource."]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        pub fn update_tags(
            &self,
            resource_group_name: impl Into<String>,
            packet_core_control_plane_name: impl Into<String>,
            parameters: impl Into<models::IdentityAndTagsObject>,
            subscription_id: impl Into<String>,
        ) -> update_tags::RequestBuilder {
            update_tags::RequestBuilder {
                client: self.0.clone(),
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PacketCoreControlPlane>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PacketCoreControlPlane>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod update_tags {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) packet_core_control_plane_name: String,
            pub(crate) parameters: models::IdentityAndTagsObject,
            pub(crate) subscription_id: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
    ...
    pub mod collect_diagnostics_package {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/collectDiagnosticsPackage" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod packet_core_control_plane_versions {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PacketCoreControlPlaneVersion>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PacketCoreControlPlaneVersion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_by_subscription {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlaneVersions/{}",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.version_name
                ))?;
...
pub mod packet_core_data_planes {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/packetCoreDataPlanes/{}" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name , & self . packet_core_data_plane_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::PacketCoreDataPlane>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::PacketCoreDataPlane>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_by_packet_core_control_plane {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/packetCoreControlPlanes/{}/packetCoreDataPlanes" , self . client . endpoint () , & self . subscription_id , & self . resource_group_name , & self . packet_core_control_plane_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-09-01");
...
pub mod sims {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Sim>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Sim>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod sim_groups {
    ...
    impl Client {
        ...
        #[doc = "Patch SIM group resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `sim_group_name`: The name of the SIM Group."]
        #[doc = "* `parameters`: Parameters supplied to patch SIM group resource."]
        pub fn update_tags(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SimGroup>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SimGroup>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod sim_policies {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SimPolicy>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SimPolicy>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod sites {
    ...
    impl Client {
        ...
        #[doc = "Deletes a packet core under the specified mobile network site."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `mobile_network_name`: The name of the mobile network."]
        #[doc = "* `site_name`: The name of the mobile network site."]
        #[doc = "* `parameters`: Parameters supplied to delete a packet core under a site."]
        pub fn delete_packet_core(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            mobile_network_name: impl Into<String>,
            site_name: impl Into<String>,
            parameters: impl Into<models::SiteDeletePacketCore>,
        ) -> delete_packet_core::RequestBuilder {
            delete_packet_core::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
    ...
    pub mod delete_packet_core {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) mobile_network_name: String,
            pub(crate) site_name: String,
            pub(crate) parameters: models::SiteDeletePacketCore,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core::Url::parse(&format!(
                    "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.MobileNetwork/mobileNetworks/{}/sites/{}/deletePacketCore",
                    self.client.endpoint(),
                    &self.subscription_id,
                    &self.resource_group_name,
                    &self.mobile_network_name,
...
pub mod slices {
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Slice>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Slice>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
