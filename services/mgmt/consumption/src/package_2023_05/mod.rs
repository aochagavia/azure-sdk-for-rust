...
pub mod charges {
    ...
    pub mod list {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ChargesListResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod reservations_summaries {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists the reservations summaries for daily or monthly grain. Note: ARM has a payload size limit of 12MB, so currently callers get 400 when the response size exceeds the ARM limit. In such cases, API call should be made with smaller date ranges."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "Lists the reservations summaries for the defined scope daily or monthly grain. Note: ARM has a payload size limit of 12MB, so currently callers get 400 when the response size exceeds the ARM limit. In such cases, API call should be made with smaller date ranges."]
        #[doc = ""]
        #[doc = "Arguments:"]
...
pub mod reservation_recommendation_details {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            #[doc = "Used to filter reservation recommendation details by: properties/subscriptionId can be specified for billing account and billing profile paths."]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::ReservationRecommendationDetailsModel>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod reservation_transactions {
    ...
    impl Client {
        ...
        pub fn list(&self, billing_account_id: impl Into<String>) -> list::RequestBuilder {
            list::RequestBuilder {
                ...
                billing_account_id: billing_account_id.into(),
                filter: None,
                use_markup_if_partner: None,
                preview_markup_percentage: None,
            }
        }
    ...
    pub mod list {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) billing_account_id: String,
            pub(crate) filter: Option<String>,
            pub(crate) use_markup_if_partner: Option<bool>,
            pub(crate) preview_markup_percentage: Option<f64>,
        }
        impl RequestBuilder {
            ...
            #[doc = "Applies mark up to the transactions if the caller is a partner."]
            pub fn use_markup_if_partner(mut self, use_markup_if_partner: bool) -> Self {
                self.use_markup_if_partner = Some(use_markup_if_partner);
                self
            }
            #[doc = "Preview markup percentage to be applied."]
            pub fn preview_markup_percentage(mut self, preview_markup_percentage: f64) -> Self {
                self.preview_markup_percentage = Some(preview_markup_percentage);
                self
            }
                    ...
                    async move {
                        ...
                        let rsp = match continuation {
                            ...
                            None => {
                                ...
                                if let Some(use_markup_if_partner) = &this.use_markup_if_partner {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("useMarkupIfPartner", &use_markup_if_partner.to_string());
                                }
                                if let Some(preview_markup_percentage) = &this.preview_markup_percentage {
                                    req.url_mut()
                                        .query_pairs_mut()
                                        .append_pair("previewMarkupPercentage", &preview_markup_percentage.to_string());
                                }
                                let req_body = azure_core::EMPTY_BODY;
                                req.set_body(req_body);
                                this.client.send(&mut req).await?
    ...
    pub mod list_by_billing_profile {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/providers/Microsoft.Consumption/reservationTransactions" , self . client . endpoint () , & self . billing_account_id , & self . billing_profile_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01");
...
pub mod price_sheet {
    ...
    impl Client {
        ...
        #[doc = "Generates the pricesheet for the provided billing period asynchronously based on the enrollment id"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `billing_account_id`: BillingAccount ID"]
        #[doc = "* `billing_period_name`: Billing Period Name."]
        pub fn download_by_billing_account_period(
            &self,
            billing_account_id: impl Into<String>,
            billing_period_name: impl Into<String>,
        ) -> download_by_billing_account_period::RequestBuilder {
            download_by_billing_account_period::RequestBuilder {
                client: self.0.clone(),
                billing_account_id: billing_account_id.into(),
                billing_period_name: billing_period_name.into(),
    ...
    pub mod download_by_billing_account_period {
        use super::models;
        #[cfg(not(target_arch = "wasm32"))]
        use futures::future::BoxFuture;
        #[cfg(target_arch = "wasm32")]
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/providers/Microsoft.Billing/billingAccounts/{}/billingPeriods/{}/providers/Microsoft.Consumption/pricesheets/download" , self . client . endpoint () , & self . billing_account_id , & self . billing_period_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01");
...
pub mod aggregated_cost {
    ...
    pub mod get_for_billing_period_by_management_group {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/providers/Microsoft.Management/managementGroups/{}/providers/Microsoft.Billing/billingPeriods/{}/providers/Microsoft.Consumption/aggregatedCost" , self . client . endpoint () , & self . management_group_id , & self . billing_period_name)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01");
...
pub mod credits {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/providers/Microsoft.Billing/billingAccounts/{}/billingProfiles/{}/providers/Microsoft.Consumption/credits/balanceSummary" , self . client . endpoint () , & self . billing_account_id , & self . billing_profile_id)) ? ;
                let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
                    url.query_pairs_mut()
                        .append_pair(azure_core::query_param::API_VERSION, "2023-05-01");
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::CreditSummary>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
